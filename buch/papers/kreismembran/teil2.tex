...
\kopfrechts{Die Hankel-Transformation}
\index{Hankel-Transformation}%
\index{Hermann Hankel}%
\index{Hankel, Hermann}%
...
\subsubsection{Definition der Hankel-Transformation
...
\subsubsection{Inverse Hankel-Transformation
...
\index{inverse Hankel-Transformation}%
\index{Hankel-Transformation, inverse}%
\begin{align}
...
\index{Ableitung der Hankel-Transformation}%
...
\begin{satz}
\index{Laplace-Operator und Hankel-Transformation}%
Wenn $\mathscr{H}_n\{f(r)\}=\tilde{f}_n(\kappa)$, dann gilt:
\begin{equation*}
