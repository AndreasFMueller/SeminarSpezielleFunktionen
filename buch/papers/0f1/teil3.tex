...
\begin{figure}
    ...
    \caption{Konvergenz mit positivem $z$; Logarithmisch dargestellte absoluter Fehler.
...
\begin{figure}
    ...
    \caption{Konvergenz mit negativem $z$; Logarithmisch dargestellte absoluter Fehler.
