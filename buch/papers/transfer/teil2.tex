...
Die Taylor-Approximation ist für den Gebrauch als Ersatz des Tangens hyperbolicus als Transferfunktion nicht brauchbar. Die Padé-Approximation kann die grössten Probleme aber entschärfen und dies mit sehr begrenztem zusätzlichen Rechenaufwand. Dafür wird die Taylor-Approximation in einen Bruch von zwei Polynom zerlegt.
...
\end{equation}
dann müssen alle $m+n$ Terme mit der Taylorapproximation um den Punkt Null übereinstimmen. Somit müssen
\begin{gather*}
	f(0) =R(0), \\
	f^{\prime}(0) =R^{\prime}(0), \\
...
Die Padé-Approximation hat einen wesentlich tieferen maximalen relativen Fehler als die Taylor-Approximation. Dieser sollte auch im Bereich liegen, dass ein Netzwerk weiterhin Vergleichbare Resultate produzieren kann. Der Rechenaufwand ist dabei vergleichbar mit dem der Taylor-Approximation. 
