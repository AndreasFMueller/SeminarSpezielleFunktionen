...
\begin{figure}
	\centering
	\input{papers/fm/Python animation/normal.pgf}
...
\begin{figure}[h]
	\centering
	\input{papers/fm/Python animation/beta_2.pgf}
...
\begin{figure}[h]
	\centering
	\input{papers/fm/Python animation/fc_150.pgf}
...
\begin{figure}[h]
	\centering
	\input{papers/fm/Python animation/fm_10.pgf}
