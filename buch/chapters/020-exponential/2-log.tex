...
gleich gross wie vier Additionen und vier Tabellenkonsultationen.
...
Mit der Tabelle~\ref{buch:trigo:table:sinus} kann zum Beispiel die
...
Das Quadrat von $2$ kann als
\(2^2 = 100 \cdot 0.2\cdot 0.2\)
berechnet werden, was mit dem Winkel
...
Falls der Winkel negativ ist, muss in den folgenden Schritten zusätzlich
...
\]
für $n=0$ bis $n=23027$ veröffentlicht.
...
\begin{beispiel}
Die in Abbildung~\ref{buch:exponential:log:fig:buergi2}
gezeigte erste Seite der Bürgischen
...
hätten.
Napier hat daher das gesamte Intervall in mehrer grössere Intervalle
...
50 Gliedern der Folge $b^k$ gefunden werden.
Und schliesslich liefern 100 Glieder der Folge $a^k$ eine geometrische
...
Briggs hat ausserdem die numerische Berechnung der Logarithmen 
weiterentwickelt und innerhalb von sieben Jahren 30000 Logarithmen mit
