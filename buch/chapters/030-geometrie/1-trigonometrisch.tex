...
% Abbildung Jakobsstab
\begin{figure}
\centering
\begin{tikzpicture}[>=latex]
\node at (0,0)
{\includegraphics[width=6cm]{chapters/030-geometrie/images/jakobsstab.jpg}};
\node at (7,0)
{\includegraphics[width=6cm]{chapters/030-geometrie/images/jakobsstab-use.jpg}};
\end{tikzpicture}
\caption{Jakobsstab und seine Verwendung zur Messung von Winkeln zwischen
Sichtlinien
\label{buch:geometrie:trigonometrisch:fig:jakobsstab}}
\end{figure}
Eines der ältesten Messgeräte für Winkel ist der Jakobsstab,
dargestellt in Abbildung~\ref{buch:geometrie:trigonometrisch:fig:jakobsstab}.
...
vergessene Funktionen im Einsatz wie zum Beispiel der Sinus versus
\[
...
zweier durch ihre geographische Länge und Breite gegebener Punkte
...
Mit ihnen lassen sich alle für die Berechnung von ebenen Dreiecken
nötigen Funktionen mit minimalem Aufwand und hoher Genauigkeit
berechnen.
...
\]
Zusammen mit dem Satz von Pythagoras kann jetzt eine grosse Zahl
...
andere Funktion.
Für Winkel ausserhalb des ersten Quadranten müssen die Vorzeichen der
...
der Koordinaten $x$ und $y$ definiert werden.
...
möglicherweise auftretenden Quadratwurzel geeignet gewählt wird.
...
\end{pmatrix}.
\end{align*}
Aus dem Vergleich der beiden Matrizen liest man die Additionstheoreme ab.
...
Ein besonders einfacher Spezialfall ist $\alpha=\beta$, es ergben sich die
Doppelwinkelformeln
\begin{align*}
...
\end{align*}
In der Formel für $\cos2\alpha$ kann man die rechte Seite durch nur
...
%
% Funktionen für mehrfache Winkel
%
...
%
% Eine Tabelle der Werte der trigonometrischen Funktionen
%
...
Aus speziellen Dreiecken kann man einige wenige bekannte Winkel
konstruieren und die zugehörigen Werte der trigonemetrischen Funktionen
bestimmen.
...
\hline
\end{tabular}
\caption{Tabelle der Werte der trigonometrischen Funktionen $\sin\alpha$
und $\cos\alpha$ für Winkel, die ganzzahlige Vielfache von $3^\circ$ sind.
...
Möglichkeit zu geben, die Werte der Sinus- und Kosinus-Funktion
