...
\node[color=darkred] at (40:\R) [above right] {$\gamma_R$};
\node[color=darkred] at (40:\repsilon) [above right] {$\gamma_\varepsilon$};
\node[color=darkred] at ({-0.5*(\R+\repsilon)},0) [above] {$\gamma_+$};
\node[color=darkred] at ({-0.5*(\R+\repsilon)},0) [below] {$\gamma_-$};
